...
http.createServer((req, res) => {
  ...
  if (req.method === 'POST' && req.url === '/convert') {
    ...
    req.on('end', () => {
      ...
      console.log('POST /convert recebido: ' + webm.length + ' bytes');
      ...
      try {
        ...
        const result = execFileSync(path.join(ROOT, '.venv/bin/python3'), [path.join(ROOT, 'convert.py'), webmPath, mp4Path], {
